...
public class OnlineCollision
{
    public static boolean mapCollision(Snake snake, GameMap map, boolean[] sounds)
    {
    ...
    public static boolean selfCollision(Snake snake, GameMap map, boolean[] sounds)
    {
    ...
    public static boolean fruitCollision(Snake snake, Consumable fruit, GameMap map, boolean[] sounds)
    {
    ...
    public static int snakesCollision(Snake[] players, GameMap map, boolean[] sounds)
    {
