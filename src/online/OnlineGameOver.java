...
public class OnlineGameOver extends JDialog
{
    ...
    public OnlineGameOver(Snake[] players, GameMode gameMode, OnlineRenderer renderer, JFrame mainWindow)
    {
	setAlwaysOnTop(true);
	setUndecorated(true);
	...
	JButton menuButton = new JButton("Volver a la sala");
	...
	gl_buttonPane
		.setHorizontalGroup(gl_buttonPane.createParallelGroup(Alignment.TRAILING).addGroup(Alignment.LEADING,
			gl_buttonPane.createSequentialGroup().addGap(152)
